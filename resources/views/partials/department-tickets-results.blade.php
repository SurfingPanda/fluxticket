{{-- Department Tickets results — server-rendered, swapped in via AJAX. Expects $tickets (paginator), $dept. --}}
@php
...
<div style="padding:4rem;text-align:center;color:var(--muted)">
    ...
    <div style="font-size:.82rem;margin-top:.35rem">
        ...
        @else
            Tickets routed to or submitted by your department will appear here.
        @endif
    </div>
</div>
@else

        ...
        <tr>
          <td style="background:#ffffff;padding:36px 36px 28px;">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:24px;">
              <tr>
                <td style="background:linear-gradient(135deg,rgba(99,102,241,.08),rgba(124,58,237,.06));border-radius:10px;padding:18px 22px;text-align:center;border:1px solid rgba(99,102,241,.2);">
                  <p style="margin:0 0 10px;font-size:.78rem;font-weight:700;color:#6366f1;text-transform:uppercase;letter-spacing:.1em;">Status Update</p>
                  <table cellpadding="0" cellspacing="0" style="margin:0 auto;">
                    <tr>
                      <td style="background:#e2e8f0;border-radius:6px;padding:6px 16px;font-size:.9rem;font-weight:700;color:#64748b;text-decoration:line-through;">
                        {{ ucfirst($oldStatus) }}
                      </td>
                      <td style="padding:0 12px;font-size:1.2rem;color:#6366f1;">&rarr;</td>
                      <td style="background:linear-gradient(135deg,#6366f1,#7c3aed);border-radius:6px;padding:6px 16px;font-size:.9rem;font-weight:700;color:#ffffff;">
                        {{ ucfirst($newStatus) }}
                      </td>
                    </tr>
                  </table>
              ...
              <tr>
                <td style="padding:20px 22px;">
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td style="padding:5px 0;font-size:.82rem;font-weight:600;color:#475569;text-transform:uppercase;letter-spacing:.06em;">New Status</td>
                      <td style="padding:5px 0;">
                    ...
                    @if($ticket->assignee)
                    <tr>
                      <td style="padding:5px 0;font-size:.82rem;font-weight:600;color:#475569;text-transform:uppercase;letter-spacing:.06em;">Assigned To</td>
                      <td style="padding:5px 0;font-size:.9rem;color:#0f172a;">{{ $ticket->assignee }}</td>
                    </tr>
                    @endif
            ...
            <div style="margin-bottom:28px;">
              <p style="margin:0 0 8px;font-size:.82rem;font-weight:600;color:#475569;text-transform:uppercase;letter-spacing:.06em;">Resolution Notes</p>
              <p style="margin:0;font-size:.9rem;color:#334155;line-height:1.6;background:#f0fdf4;border-radius:6px;padding:14px 16px;border:1px solid #bbf7d0;border-left:4px solid #22c55e;">
                {{ $ticket->resolution }}
              </p>
            </div>
            @endif

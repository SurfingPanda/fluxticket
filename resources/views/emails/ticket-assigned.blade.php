        ...
        <tr>
          <td style="background:#ffffff;padding:36px 36px 28px;">
            ...
            <p style="margin:0 0 24px;font-size:.9rem;color:#475569;">
              A new ticket has been assigned to you on <strong style="color:#6366f1;">ECTicketing</strong>. Please review the details below and take the necessary action.
            </p>
        ...
        <tr>
          <td style="background:#1e293b;border-radius:0 0 12px 12px;padding:18px 36px;text-align:center;">
            <p style="margin:0 0 4px;font-size:.78rem;color:#94a3b8;">
              You received this email because a ticket was assigned to you on ECTicketing.
            </p>
